# image-mode-security-firewall

In this hands-on lab, you will learn how to add firewall rules as part of your image hardening procedures at build-time on a bootc image.
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/image-mode-security-firewall`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/image-mode-security-firewall
   ```
3. `cd image-mode-security-firewall`
